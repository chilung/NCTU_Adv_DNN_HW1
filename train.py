...
schedulers = [MultiStepLR(raw_optimizer, milestones=[60, 100, 150], gamma=0.2),
              MultiStepLR(concat_optimizer, milestones=[60, 100, 150], gamma=0.2),
              MultiStepLR(part_optimizer, milestones=[60, 100, 150], gamma=0.2),
              MultiStepLR(partcls_optimizer, milestones=[60, 100, 150], gamma=0.2)]
net = net.cuda()
