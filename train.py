...
schedulers = [MultiStepLR(raw_optimizer, milestones=[60, 100, 170], gamma=0.1),
              MultiStepLR(concat_optimizer, milestones=[60, 100, 170], gamma=0.1),
              MultiStepLR(part_optimizer, milestones=[60, 100, 170], gamma=0.1),
              MultiStepLR(partcls_optimizer, milestones=[60, 100, 170], gamma=0.1)]
net = net.cuda()
