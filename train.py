...
#milestones=[60,100]
milestones=[2]
schedulers = [MultiStepLR(raw_optimizer, milestones=milestones, gamma=0.2),
              MultiStepLR(concat_optimizer, milestones=milestones, gamma=0.2),
              MultiStepLR(part_optimizer, milestones=milestones, gamma=0.2),
              MultiStepLR(partcls_optimizer, milestones=milestones, gamma=0.2)]
net = net.cuda()
